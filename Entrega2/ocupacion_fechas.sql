...
RETURN QUERY EXECUTE 'SELECT muelles.iid, instalaciones.capacidad, permisos.atraque
		...
		WHERE t1 = $1 and t2= $2 and instalaciones.iid = muelles.iid and muelles.iid = para_m.iid and para_m.per_id = permisos.per_id and permisos.atraque >= $1 and permisos.atraque <= $2'
	USING t1,t2;
	RETURN;
END
$$ language plpgsql